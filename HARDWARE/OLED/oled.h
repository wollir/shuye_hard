...
#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_6)//DIN
...
//IO方向设置
#define OLED_SDA_IN()  {GPIOB->MODER&=~(3<<(6*2));GPIOB->MODER|=0<<6*2;}	//PB9输入模式
#define OLED_SDA_OUT() {GPIOB->MODER&=~(3<<(6*2));GPIOB->MODER|=1<<6*2;} //PB9输出模式
//IO操作函数	 
#define OLED_IIC_SCL    PBout(5) //SCL
#define OLED_IIC_SDA    PBout(6) //SDA	 
#define OLED_READ_SDA   PBin(6)  //输入SDA 
